...
router.get("/location-orders",async(req,res)=>{
    ...
    const onLocationOperationData_second=onLocationOperationData_first.filter(item=>item.MOBLZ_ARAC_ENLEM !=="")
    const onLocationOperationData_verfied=onLocationOperationData_second.filter(item=>item.MOBLZ_ARAC_BOYLAM !=="")
